...
$(document).on('click', '.btn-modal', function(){
    ...
    var longitude = $(this).attr("data-longtitude");
    var name = $('.employees_name').html();
    $(".modal-title-name").html(name);
    document.getElementById("iframe-map").innerHTML ='<iframe src="sw-mod/absensi/map.php?latitude='+latitude+'&longtitude='+longitude+'&name='+name+'" frameborder="0" width="100%" height="400px" marginwidth="0" marginheight="0" scrolling="no">';
});
